...
export const projectLists = [
  {
    ...
    architecture: [
      'React Query를 활용하여 서버 상태 관리 및 캐시 처리',
    ...
    problemSolving: [
      {
        ...
        description: 'React Query와 Zustand의 역할을 구분하여 데이터 요청과 UI 상태를 명확히 분리했습니다.\n이를 통해 캐시 관리와 전역 UI 상태를 각각 책임에 맞게 관리할 수 있도록 설계했습니다.',
      },
      {
    ...
    refactoring: [
      ...
      'Local State → React Query + Zustand 적용',
      '단일 구조 → Component & Custom Hook 분리',
      'CRUD 중심 → 로딩/에러/Empty UI 추가',
    ],
    technologies: ['React', 'TypeScript', 'React Query', 'Zustand', 'Supabase', 'Tailwind CSS'],
    links: {
